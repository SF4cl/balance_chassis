...
Vmc::Vmc(const f32 l1, const f32 l2, const f32 l5) : l1_(l1), l2_(l2), l5_(l5), jacobi_(2, 2) {}
...
void Vmc::Update() {
  ...
  jacobi_(0, 0) = l1_ * arm_sin_f32(phi0_ - phi3_) * arm_sin_f32(phi1_ - phi2_) / arm_sin_f32(phi3_ - phi2_);
  jacobi_(0, 1) = l1_ * arm_sin_f32(phi0_ - phi3_) * arm_sin_f32(phi1_ - phi2_) / (l0_ * arm_sin_f32(phi3_ - phi2_));
  jacobi_(1, 0) = l1_ * arm_sin_f32(phi0_ - phi2_) * arm_sin_f32(phi3_ - phi4_) / arm_sin_f32(phi3_ - phi2_);
  jacobi_(1, 1) = l1_ * arm_sin_f32(phi0_ - phi2_) * arm_sin_f32(phi3_ - phi4_) / (l0_ * arm_sin_f32(phi3_ - phi2_));
}